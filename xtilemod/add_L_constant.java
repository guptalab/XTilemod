 ...
 * Addition of two integers using L configuration with constant 16 computational tiles
...
//taking second input and converting it into binary..
		...
		fileName = "add_L_con_"+one+","+two+".tiles";
		//opening the file
		try
		{
		...
		fp.println("% " + fileName + " (L configuration constant tile adder)");
		...
		//----16 COMPUTATION TILE SET GENERATION
		for(int i=0; i<4; i++)
		{
